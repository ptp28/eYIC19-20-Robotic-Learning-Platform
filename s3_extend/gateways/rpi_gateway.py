...
import sys
import time
from Adafruit_CharLCD import Adafruit_CharLCD              #change
...
class RpiGateway(GatewayBase):
    ...
    def __init__(self, *subscriber_list, **kwargs):
        ...
        # variables to hold instances of sonar and 
    ...
    def digital_servo(self, topic, payload):	
        print("adasd")
        servoPIN = 17
    ...
    def temperature(self, topic, payload):
        """
        This method performs a digital write
        :param topic: message topic
        :param payload: {"command": "digital_write", "pin": “PIN”, "value": “VALUE”}
    ...
    def set_text(self, topic, payload):
        """
        LCD screen
        """
        self.lcd = LCD()
