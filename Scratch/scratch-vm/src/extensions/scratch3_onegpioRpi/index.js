/*
                            ...
                            * Author List:      Shantanu Kalamdane, Akash Rasal, Parth Parikh
                            * Filename:         index.js
                            * Functions:        ip_address(),LCD_write(),LCD_clear(),
                                                digita_write(),LED_digital_write(),
                                                Buzzer_digital_write(),servo(),
                                                digital_read(),Phototransistor_digital_read(),
                                                FireFlame_digital_read(),pir_digital_read(),
                                                sound_detection_digital_read(),
                                                Ultrasonic_sonar_read(),pwm_write(),tone_on()
                            * Global Variables: ArgumentType,BlockType,formatMessage
                            *
*/
...
class Scratch3RpiOneGPIO {
    ...
    getInfo() {
        ...
        return {
            ...
            blocks: [
                {
                    ...
                    defaultValue: 'raspberrypi.local' //menu: "digital_pins"
            ...
            opcode: 'LCD_WRITE',
            blockType: BlockType.COMMAND,
            //text: 'Write Text : [TEXT] to Port : [LCD_PORT]',
            text: 'Display Text : [TEXT] to LCD Port : [LCD_PORT]',
            arguments: {
              TEXT: {
                type: ArgumentType.STRING,
          ...
          },
          {
            ...
            blockType: BlockType.COMMAND,
            //text: 'Write Text : [TEXT] to Port : [LCD_PORT]',
            text: 'Clear text from LCD Port : [LCD_PORT]',
            arguments: {
              LCD_PORT: {
                type: ArgumentType.NUMBER,
                defaultValue: 'D1',
          ...
          }, 
          {
            ...
            {
            opcode: 'LED_digital_write',
            blockType: BlockType.COMMAND,
            text: "Toggle LED [PIN] [ON_OFF]",
            arguments: {
              PIN: {
                type: ArgumentType.NUMBER,
                defaultValue: '4',
          ...
          {
            opcode: 'Buzzer_digital_write',
            blockType: BlockType.COMMAND,
            text: "Toggle Buzzer [PIN] [ON_OFF]",
            arguments: {
              PIN: {
                type: ArgumentType.NUMBER,
                defaultValue: '4',
...

        {
            ...
            arguments: {
                ...
                {
            //New Block
            opcode: 'Phototransistor_digital_read',
            blockType: BlockType.REPORTER,
            //text: 'Write Digital Pin [PIN] [ON_OFF]',
            text: 'Phototransister Sensor [PIN]',
            ...
            arguments: {
                ...
                {
            //New Block
            opcode: 'FireFlame_digital_read',
            blockType: BlockType.REPORTER,
            //text: 'Write Digital Pin [PIN] [ON_OFF]',
            text: 'Fire/Flame Sensor [PIN]',
            ...
            arguments: {
                ...
                {
            //New Block
            opcode: 'PIR_digital_read',
            blockType: BlockType.REPORTER,
            //text: 'Write Digital Pin [PIN] [ON_OFF]',
            text: 'Motion Sensor [PIN]',
            ...
            arguments: {
                ...
                {
            //New Block
            opcode: 'sound_detection_digital_read',
            blockType: BlockType.REPORTER,
            //text: 'Write Digital Pin [PIN] [ON_OFF]',
            text: 'Sound Detection Sensor [PIN]',
            ...
            arguments: {
                ...
                {
            opcode: 'Ultrasonic_sonar_read',
            blockType: BlockType.REPORTER,
            text: 'Ultrasonic Sensor T [TRIGGER_PIN] E [ECHO_PIN]',
    ...
    LCD_WRITE(args) {
      ...
      if (!connected) {
        var callbackEntry = [this.LCD_WRITE.bind(this), args];
        wait_open.push(callbackEntry);
      } else {
        var port = args['LCD_PORT'];
        var value = args['TEXT'];
        msg = {
            "command": "lcd_write",
            "pin": port,
    ...
    LCD_CLEAR(args) {
      ...
      if (!connected) {
        var callbackEntry = [this.LCD_CLEAR.bind(this), args];
        wait_open.push(callbackEntry);
      } else {
        var port = args['LCD_PORT'];
        msg = {
    ...
    pwm_write(args) {
      ...
      if (!connected) {
        ...
        var pin = args['PIN']; // maximum value for RPi and Arduino

        var the_max = 255;
        pin = parseInt(pin, 10);
        var value = args['VALUE'];
        value = parseInt(value, 10); // calculate the value based on percentage
    ...
    tone_on(args) {
      ...
      if (!connected) {
        ...
        duration = parseInt(duration, 10); // make sure duration maximum is 5 seconds
    ...
    //
    Phototransistor_digital_read(args) {
      if (!connected) {
        if (!connection_pending) {
          this.connect();
          connection_pending = true;
    ...
    //
    sound_detection_digital_read(args) {
      if (!connected) {
        if (!connection_pending) {
          this.connect();
          connection_pending = true;
