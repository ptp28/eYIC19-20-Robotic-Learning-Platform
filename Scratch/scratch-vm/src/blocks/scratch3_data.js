/*
                            ...
                            * Author List:      Shantanu Kalamdane, Akash Rasal,Khushboo Mundada,Parth Parikh
                            * Filename:         scratch3_data.js
                            * Functions:        getPrimitives(),getVariable(),setVariableTo()
                                                changeVariableBy(),changeMonitorVisibility(),
                                                showVariable(),hideVariable(),showList(),hideList(),
                                                getListContents(),addToList(),deleteOfList(),addToList()
                                                insertAtList(),replacementItemOfList(),getItemList(),getItemNumOfList()
                                                lengthOfList(),listContainsItem()
                            * Global Variables: Cast
                            *
*/
