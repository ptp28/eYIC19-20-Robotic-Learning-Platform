...
class Scratch3RpiOneGPIO {
    ...
    Ultrasonic_read(args) {
        ...
        if (!connected) {
            let callbackEntry = [this.User_Ultrasonic_read.bind(this), args];
            wait_open.push(callbackEntry);
        } else {
